...
export class ServerComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.appSub.userSub.subscribe(res => console.log('[SERVER OnInit Subject]', res))
        this.appSub.userBehSub.subscribe(res => console.log('[SERVER OnInit Behav]', res))
        this.appSub.userReplaySub.subscribe(res => console.log('[SERVER OnInit Replay]', res))
        this.appSub.userAsyncSub.subscribe(res => console.log('[SERVER OnInit Async]', res))
    }
}